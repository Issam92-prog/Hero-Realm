...
std::vector<Carte*> CarteDB::getImperialCards() {
    ...
    darian->setEffetExpend(0, 3, 0, 0); // Le choix sera géré dans l'implémentation
    cards.push_back(darian);
    
    // Domination (1 exemplaire)
    ...
    // Ralliement des Troupes (1 exemplaire)
...
std::vector<Carte*> CarteDB::getNecrosCards() {
    ...
    // Sombre Récompense (1 exemplaire)
...
std::vector<Carte*> CarteDB::getWildCards() {
    ...
    // Malédiction Elfique (2 exemplaires)
